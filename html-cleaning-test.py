...
content=bs.find(class_='article-body')  #THIS IS THE MAIN PROBLEM (the developer has to inspect the html and find the container class for that specific page for this to work
